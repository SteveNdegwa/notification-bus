...
class NotificationAdmin(admin.ModelAdmin):
    list_display = (
        'system', 'notification_type', 'recipient', 'template', 'provider', 'context', 'sent_time', 'status',
        'date_modified', 'date_created')
    list_filter = ('system', 'notification_type', 'template', 'provider', 'status')
    search_fields = (
        'id', 'system__name', 'notification_type__name', 'recipient', 'template__name', 'provider__name',
        'status__name')
